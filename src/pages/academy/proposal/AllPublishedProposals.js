...
export default function AllPublishedProposals() {
    ...
    const getProposals = async () => {
        try {
            apiCall.current = API.request('/proposal/published/', false, {}, globalUser.accessToken);
    ...
    return (
        <>
            ...
            <Navbar children={<UserDashboard currentTab={"proposal"} thirdChildSelected={true} />} />
            <section
                    ...
                    <div className={classes.whiteBox}>
                        <div className="row">
                            <div className="col-sm-3 no-mobile">
                                <UserDashboard currentTab={"proposal"} thirdChildSelected={true} />
                            </div>
