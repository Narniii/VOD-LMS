...
export default function ReciptPreviewSuccess(props) {
                                            ...
                                            <div className={classes.container}>
                                                <Paper className={classes.paper}>
                                                    ...
                                                    <div className="text-dark">
                                                        <h2 style={{ color: 'black' }}>پرداخت شما موفقیت آمیز بوده است</h2>
                                                        <div>عنوان درس:{course.title}</div>
                                                        <div>شماره پیگیری:{payment.ref_id}</div>
                                                        <div>تاریخ پرداخت:{payment.paid_at}</div>
