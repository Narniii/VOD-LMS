...
export default function CreateQuiz() {
    ...
    const quizSubmit = async () => {
        ...
        if (timeToDone == 0) {
            setErr("لطفا زمان انجام کوییز را مشخص کنید")
            return
        }
        ...
        try {
            ...
            else if (res.title[0] == "quizz with this title already exists.")
                setErr("کوییزی با این عنوان وجود دارد")
        }
        catch (err) {
            console.log(err)
        }
                                                ...
                                                <div className={classes.quizContainer}>
                                                    <div className="row">
                                                        <div className="col-md-4">
                                                            <div className={classes.subHeaders}>انتخاب دوره</div>
                                                        </div>
                                                        ...
                                                        <div className="col-md-8">
                                                            <input maxLength={50} className="form-control" type='text' name="title" onChange={onTitleChange} value={quiz.title} />
                                                        </div>
                                                        <div className="col-md-4">
