...
import Loading from '../../pages/ExtraPages/Loading'
...
export default function NewEditProfile(props) {
    ...
    return (
        <>
            <NewUserDashboard currentTab="profile" firstChildSelected={true}>
                <Helmet>
                    <meta charSet="utf-8" />
                    <title>ویرایش اطلاعات کاربری</title>
                    <link rel="canonical" href="http://aqua.ir/edit-profile" />
                </Helmet>
                {/* ==========image ========== */}
                {loading ?
                    <div style={{
